...
window.SITE_CONFIG = {
    name:             "EventHub",
    tagline:          "Discover music, sports, and events happening near you — find something to do tonight, this weekend, or next month.",
    ...
    locale:           "en_US",
    locale_hreflang:  "en",
    twitter:          "@eventhub",                     // TODO: replace with real handle at deploy, or remove if none
